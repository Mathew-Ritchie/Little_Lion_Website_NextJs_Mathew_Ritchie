...
export default function About() {
  return (
    <section
      id="about-us"
      className="about-section w-full h-auto relative overflow-hidden flex items-center justify-center md:justify-end before:content-[''] before:absolute before:inset-0 before:bg-gray-200 before:-z-20"
    >
      <div
      ...
      ></div>
      <div className=" w-full md:w-1/2 h-auto px-5 text-center md:text-start  bg-black/50 flex flex-col justify-center text-white">
